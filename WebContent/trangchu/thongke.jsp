...
<body>
	...
	<h1>Thống kê lượt xem của từng video</h1>
	<a href="/Assignment/thongkeyeuthich">Thống kê yêu thích</a>
	<main class="container">
	<div class="row">
		<div class="col-6">
			<canvas id="myvideoview"></canvas>
	...
	<script>
		let view = [], tittle = []
		<c:forEach var="item" items="${items}">
			tittle.push('${item.tittle}')
			view.push(${item.viewer})
		</c:forEach>
		window.onload = function() {
			videochart("myvideoview",view,tittle)
		}
	</script>

	<script src="/Assignment/trangchu/chart.js"></script>
