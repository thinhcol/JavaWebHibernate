	...
	<div class="hero-section">
		...
		<div class="hero-slide">
			<div class="owl-carousel carousel-nav-center" id="hero-carousel">
				...
				<div class="hero-slide-item">
					<img src="/Assignment/trangchu/images/black-banner.png" alt="">
				...
				<!-- SLIDE ITEM -->
				<div class="hero-slide-item">
					<img src="/Assignment/trangchu/images/supergirl-banner.jpg" alt="">
					<div class="overlay"></div>
					<div class="hero-slide-item-content">
						<div class="item-content-wraper">
				...
				<!-- SLIDE ITEM -->
				<div class="hero-slide-item">
					<img src="/Assignment/trangchu/images/wanda-banner.jpg" alt="">
					<div class="overlay"></div>
					<div class="hero-slide-item-content">
						<div class="item-content-wraper">
		...
		<div class="top-movies-slide">
			<div class="owl-carousel" id="top-movies-slide">
				<!-- MOVIE ITEM -->
				<c:forEach var="film" items="${items}">
					<a href="/Assignment/videochitiet?idvs=${film.idvs}">
						<div class="movie-item">
							<img src="/Assignment/trangchu/images/${film.poster}" alt="">
							<div class="movie-item-content">
								<div class="movie-item-title">${film.tittle}</div>
								<div class="movie-infos">
									<div class="movie-info">
										<i class="bx bxs-star"></i> <span>9.5</span> <span>${film.active?'On':'Off'}</span>
									</div>
									<div class="movie-info">
										<i class="bx bxs-time"></i> <span>120 mins</span> <span>Lượt
											xem : ${film.viewer}</span>
									</div>
									<div class="movie-info">
										<span>HD</span>
									</div>
